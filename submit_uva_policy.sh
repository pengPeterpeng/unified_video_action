...
accelerate launch --num_processes=8 train.py \
    ...
    model.policy.autoregressive_model_params.pretrained_model_path=checkpoints/uva_libero_video_model/checkpoints/latest.ckpt \
    ...
    hydra.run.dir="checkpoints/uva_libero_video_policy_model"
